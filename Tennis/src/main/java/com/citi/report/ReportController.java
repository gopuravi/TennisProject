...
import com.citi.report.service.ReportInitService;
import com.citi.report.service.ReportService;
import com.citi.report.util.Constant;
import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.citi.report.exception.CustomResponseEntityExceptionHandler;
import com.citi.report.exception.ResponeException;
...
public class ReportController  {
	...
	public String getMessage() throws ResponeException {
		...
		if(1==1)
		 throw new ResponeException("Test Exception");
		return "csalayout123";   
	}
